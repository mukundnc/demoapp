package com.example.webapi.webapi.models;
...
public class Tour {
    ...
    public Tour(String title, String description, String blurb, Integer price, String duration, String bullets,
                String keywords, Difficulty difficulty, Region region) {
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, title, description, blurb, price, duration, bullets, keywords, difficulty,
                region);
    }
}